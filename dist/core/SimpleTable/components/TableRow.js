...
exports.default = (function (props) {
    var row = props.row, columns = props.columns, styles = props.styles, header = props.header, groupHeader = props.groupHeader, expandForm = props.expandForm, last = props.last, hideHeaders = props.hideHeaders;
