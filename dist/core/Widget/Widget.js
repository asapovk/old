...
exports.default = (function (props) {
    var title = props.title, loading = props.loading, onClick = props.onClick, className = props.className, style = props.style, children = props.children;
    var styles = styles_1.default(typeof onClick === 'function');
