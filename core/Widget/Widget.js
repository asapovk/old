...
exports.default = (function (props) {
    var title = props.title, loading = props.loading, onClick = props.onClick, className = props.className, style = props.style, children = props.children, decoration = props.decoration, hoverable = props.hoverable;
    var styles = styles_1.default(hoverable || false, decoration);
