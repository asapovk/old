...
exports.default = (function (props) {
    ...
    var items = data.map(function (item, index) { return (core_1.jsx(index_1.Flexbox, { alignItems: 'center', onClick: function () { return onChoose(index); }, key: 'lmi-' + index, css: styles.menu.item(index === active, groups) },
