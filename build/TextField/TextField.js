...
var UITextField = /** @class */ (function (_super) {
    ...
    UITextField.prototype.render = function () {
        var _this = this;
        var _a = this.props, label = _a.label, value = _a.value, defaultValue = _a.defaultValue, style = _a.style, onChange = _a.onChange, theme = _a.theme;
        var classes = styles_1.default(theme);
        return (React.createElement("div", { className: classes.main, style: style },
            React.createElement("div", { className: classes.label }, label),
            React.createElement("input", { className: classes.input, defaultValue: defaultValue, value: value, onChange: function (event) {
