    ...
    if (!nextStep)
        return (react_1.default.createElement(react_1.Fragment, null,
            ...
            login.value && (react_1.default.createElement(__1.Flexbox, { pt: '1rem' },
                react_1.default.createElement(__1.TextField, __assign({}, password, { placeholder: props.value === 'RECOVER' ? 'Новый пароль' : "Придумайте пароль", type: "password", decoration: 'borderBottom', size: 'large' })))),
            login.value && password.value.length >= props.newPasswordsMinLength && (react_1.default.createElement(__1.Flexbox, { pt: '1rem' },
                react_1.default.createElement(__1.TextField, __assign({}, password2, { placeholder: "\u041F\u043E\u0432\u0442\u043E\u0440\u0438\u0442\u0435 \u043F\u0430\u0440\u043E\u043B\u044C", type: "password", decoration: 'borderBottom', size: 'large' })))),
        ...
        return (react_1.default.createElement(react_1.Fragment, null,
            react_1.default.createElement(__1.Flexbox, null,
                react_1.default.createElement("div", { onClick: function () { return setNextStep(false); }, style: styles.scenes.lkguest.backButton },
                    react_1.default.createElement(__2.Icon, { type: "left", style: __assign({}, styles.scenes.lkguest.backButtonIcon, { fontSize: '1.5 rem' }) })),
                react_1.default.createElement(__1.Flexbox, null,
                    react_1.default.createElement(__1.TextField, __assign({}, code, { placeholder: "\u041A\u043E\u0434 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u0438\u044F", decoration: 'borderBottom', size: 'large' })))),
            react_1.default.createElement(__1.Flexbox, { justifyContent: "space-around", pt: '1rem' },
                react_1.default.createElement(__1.Flexbox, null,
