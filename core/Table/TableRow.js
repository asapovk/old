...
var TableRow = function (props) {
    var row = props.row, isBlur = props.isBlur, actions = props.actions, columns = props.columns, form = props.form, onRowClick = props.onRowClick;
    var styles = styles_1.default();
    if (form) {
        return TableForm_1.default(form, columns, row);
    }
    return (core_1.jsx("div", { css: styles.row(false), onClick: function () { return onRowClick && onRowClick(row); } },
