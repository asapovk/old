...
exports.default = (function (props) {
    ...
    return (core_1.jsx(__1.Flexbox, { alignItems: 'center' }, items.map(function (item, index) {
        ...
        return (core_1.jsx(__1.Flexbox, { key: index, css: menu.elementContainer, onClick: function () { return onItemClick(index); } },
            core_1.jsx(__1.Flexbox, { css: menu.itemContent({ isActive: isActive }), children: item.title })));
    })));
});
