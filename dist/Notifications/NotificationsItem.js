...
var NotificationsItem = /** @class */ (function (_super) {
    ...
    NotificationsItem.prototype.render = function () {
        ...
        return (react_1.default.createElement(__1.Styles, null, function (styles) { return (react_1.default.createElement("div", { className: "ui-notifications-item", style: styles.notifications.main(options.decoration) },
