...
var Grid = function (props) {
    ...
    return rows
        ...
        row.name && (opened.length < breakpoints[1] || isFirst) && (core_1.jsx(__1.HR, { dotted: true, color: "light", css: core_1.css({ margin: "0.35rem 0.5rem", flex: 1 }) })),
        core_1.jsx(__1.T1, { css: core_1.css({ flexShrink: 0 }), children: data[dataIndex][row.dataKey], format: row.format, unit: row.unit }))); });
};
