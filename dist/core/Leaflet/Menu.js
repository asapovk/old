...
exports.default = (function (props) {
    ...
    var items = data.map(function (item, index) {
        console.log(item);
        return (core_1.jsx(index_1.Flexbox, { alignItems: 'center', justifyContent: 'space-between', onClick: function () { return onChoose(index); }, key: 'lmi-' + index, css: styles.menu.item(index === active, groups) },
            core_1.jsx(index_1.Flexbox, { alignItems: 'center' },
                isMobile && core_1.jsx(index_1.Icon, { size: '1.25rem', mr: '0.5rem', type: item.glyph, color: 'light' }),
                nameRender
                    ? nameRender(item, item[nameKey])
                    : core_1.jsx(index_1.T1, { ellipsis: true, children: item[nameKey] })),
