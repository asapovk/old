...
function MobileMenuItems(props) {
    ...
    return (core_1.jsx(__1.Flexbox, { alignItems: "center", flexDirection: "column", css: styles.mobile(active) }, items.map(function (item) { return (core_1.jsx(PanelBarItem_1.default, { css: styles.item(value === item.value, true), key: item.value, text: item.text, value: item.value, onClick: function (value) { return onChange && onChange(value); } })); })));
}
