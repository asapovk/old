...
var CSpoiler_1 = __importDefault(require("./CSpoiler"));
var CSelectField_1 = __importDefault(require("./CSelectField"));
var CDatePicker_1 = __importDefault(require("./CDatePicker"));
var CCheckBox_1 = __importDefault(require("./CCheckBox"));
...
var CDivider_1 = __importDefault(require("./CDivider"));
var CAttachment_1 = __importDefault(require("./CAttachment"));
var Constructor = /** @class */ (function (_super) {
    ...
    function Constructor(props) {
        ...
        var CreateComponent = function (object) {
            ...
            switch (object.$) {
                ...
                case "divider":
                    return (react_1.default.createElement(CDivider_1.default, { getConstructor: function (_) { return _this; }, object: object, key: object.$id }));
                case "select":
                case "selectfield":
                ...
                case "spoiler":
                    return (react_1.default.createElement(CSpoiler_1.default, { getConstructor: function (_) { return _this; }, object: object, key: object.$id, ref: addRef, onValueChange: _this.onChange.bind(_this), children: react_1.default.createElement(Component, { object: object.$children }) }));
                case "datepicker":
                    return (react_1.default.createElement(CDatePicker_1.default, { getConstructor: function (_) { return _this; }, object: object, key: object.$id, ref: addRef, onValueChange: _this.onChange.bind(_this) }));
                case "checkbox":
                    return (react_1.default.createElement(CCheckBox_1.default, { getConstructor: function (_) { return _this; }, object: object, key: object.$id, ref: addRef, onValueChange: _this.onChange.bind(_this) }));
                case "button":
                ...
                case "attachment":
                    return (react_1.default.createElement(CAttachment_1.default, { getConstructor: function (_) { return _this; }, object: object, key: object.$id, ref: addRef, onValueChange: _this.onChange.bind(_this) }));
     ...
     *
     */
    Constructor.prototype.onChange = function ($id, $, value) {
        var _this = this;
        var valueObject = { $id: $id, $: $, value: value };
