...
exports.default = (function (props) {
    var data = props.data, columns = props.columns, groupKey = props.groupKey, groups = props.groups, styles = props.styles, expandForm = props.expandForm;
    ...
    if (groupKey && (Array.isArray(groups) && groups.length > 0)) {
        return (core_1.jsx(react_1.Fragment, null, groups.map(function (group, index) { return (core_1.jsx("div", { key: "group-" + index, id: "group-" + index },
            core_1.jsx(GroupHeaderRow_1.default, { columns: cols, title: group.title, styles: styles, expandForm: expandForm }),
    ...
    return (core_1.jsx(DataRows_1.default, { data: data, columns: cols, styles: styles, expandForm: expandForm }));
});
