...
exports.default = (function (props) {
    var row = props.row, columns = props.columns, styles = props.styles, header = props.header, groupHeader = props.groupHeader, expandForm = props.expandForm, last = props.last;
    ...
    return (core_1.jsx("div", { css: styles.rowContainer({ header: header }), ref: rowRef },
