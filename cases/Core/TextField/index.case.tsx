    ...
    return (
        <Flexbox alignContent="center" justifyContent='center' p={40}>
            <Flexbox column flexBasis='640px'>
                ...
                <Flexbox pb={40}>
                    <TextField leftIcon="down" size='small' label='Small field' placeholder="Write secret here" />
                </Flexbox>
                <Flexbox pb={40}>
                    <TextField leftIcon="up" size='large' label='Large field' placeholder="Really big" />
                </Flexbox>
